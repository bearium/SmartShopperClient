...
<small><sub>Version: 10.2.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.ReplayStartLocation
				</h1>
			</div>
		</header>
...
contains the elapsed time in milliseconds since the epoch in ReplayStartLocationDate</p></p></div>
			...
			<table>
				<tbody>
					<tr>
						<td class="type">&nbsp;</td>
						<td class="last">
							<a href="#ReplayStartLocation">ReplayStartLocation</a>
							<span>(  )</span>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-replaystart_lib_replayStartLocation_js.html#lineno20">replayStartLocation.js</a> at line 20
-->
  </div>
