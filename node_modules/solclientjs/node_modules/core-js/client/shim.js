...
if (!$typed.ABV) {
  ...
  if (!fails(function () {
    // Coverity flags this as an error and it probably is, based
    // on the other functions defined below maybe this should be
    // new $ArrayBuffer(1) // eslint-disable-line no-new
    // assuming the the comment is some sort of eslint annotation to
    // avoid eslint errors.  But seeing as this code is so obtuse and
    // we have no known problems I am going to annotate it instead
