...
The base class for all errors thrown by the API.</p></p></div>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-error_lib_solace-error_js.html#lineno10">solace-error.js</a> at line 10
-->
  </div>
