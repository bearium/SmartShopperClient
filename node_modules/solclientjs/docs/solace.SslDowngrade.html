...
<small><sub>Version: 10.2.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.SslDowngrade
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Effectively a boolean governing TLS downgrade to plain text after authentication.</p></p><p>See <a href="solace.SessionProperties.html#sslConnectionDowngradeTo">solace.SessionProperties#sslConnectionDowngradeTo</a></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#NONE">
        	<abbr title="solace.SslDowngrade.NONE">
        		NONE
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#PLAINTEXT">
        	<abbr title="solace.SslDowngrade.PLAINTEXT">
        		PLAINTEXT
        	</abbr>
        </a>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-session_lib_ssl-downgrades_js.html#lineno18">ssl-downgrades.js</a> at line 18
-->
  </div>
...
<div class="description "><p><p>No downgrade, TLS connection remains encrypted.</p></p></div>
...
<h3 id="PLAINTEXT" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-session_lib_ssl-downgrades_js.html#lineno23">ssl-downgrades.js</a> at line 23
-->
  </div>
...
<div class="description "><p><p>TLS connection downgrades to plain text after authentication.
USE WITH CAUTION! Message traffic is not encrypted!</p></p></div>
